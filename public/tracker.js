/*
* Собрать абсолютно все данные (особенно IP и город) исключительно силами JavaScript на стороне клиента
  невозможно по соображениям безопасности браузеров.
* Браузер скрывает реальный IP-адрес пользователя от клиентского JavaScript для защиты конфиденциальности.
* Основной сбор данных в TrackerController.php
*/
(function () {
    'use strict';
